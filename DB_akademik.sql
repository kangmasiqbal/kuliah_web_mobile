...
--
-- Host: 127.0.0.1
-- Generation Time: 18 Jun 2021 pada 10.32
-- Versi Server: 5.6.25
-- PHP Version: 5.6.11
...
(1, 'Company A', 'Bedecs', 'Anna', '', 'Owner', '(123)555-0100', '', '', '(123)555-0101', '123 1st Street', 'Seattle', 'WA', NULL, 'USA', '', '', ''),
...
(30, 'a1', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', NULL, 'a', 'a', 'a', 0x61);
...
(10, 'a11', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', NULL, 'a', 'a', 'a', 0x61);

-- --------------------------------------------------------

--
-- Struktur dari tabel `employee_privileges`
--
...
--
-- Dumping data untuk tabel `employee_privileges`
--
...
--
-- Struktur dari tabel `inventory_transaction_types`
--
...
--
-- Dumping data untuk tabel `inventory_transaction_types`
--
...
--
-- Struktur dari tabel `orders_status`
--
...
--
-- Dumping data untuk tabel `orders_status`
--
...
--
-- Struktur dari tabel `orders_tax_status`
--
...
--
-- Dumping data untuk tabel `orders_tax_status`
--
...
--
-- Struktur dari tabel `order_details_status`
--
...
--
-- Dumping data untuk tabel `order_details_status`
--
...
(NULL, 0, NULL, NULL, NULL, NULL, '0.0000', NULL, NULL, NULL, 0, NULL, NULL, NULL),
...
--
-- Dumping data untuk tabel `strings`
--
...
--
-- Ketidakleluasaan untuk tabel `employee_privileges`
--
ALTER TABLE `employee_privileges`
